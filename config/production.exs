...
# Redis - Production (high pool size)
...
config :notification_orchestrator, :kafka,
  ...
  consumer_group: "notification-orchestrator-production",
...
# libcluster - Production (Kubernetes DNS strategy)
config :libcluster,
  topologies: [
